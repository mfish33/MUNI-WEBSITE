...
@Component({
  selector: 'app-about-page-desktop',
  templateUrl: './about-page-desktop.component.html',
  styleUrls: ['./about-page-desktop.component.scss']
})
export class AboutPageDesktopComponent implements OnInit,AfterViewInit {
